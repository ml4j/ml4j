...
public class LayeredSupervisedFeedForwardNeuralNetworkImpl extends
	 ...
	 * @param outputs           The desired output labels
	...
	public ForwardPropagation forwardPropagate(NeuronsActivation inputActivation,
		...
		return new ForwardPropagationImpl(inputActivation, trailingActivationFunctionComponentChain.forwardPropagateChain(inputActivation,
