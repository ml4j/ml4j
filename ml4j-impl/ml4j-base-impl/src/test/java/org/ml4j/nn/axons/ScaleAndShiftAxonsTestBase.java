...
public abstract class ScaleAndShiftAxonsTestBase {
  ...
  public void testPushLeftToRightWithLeftHandBias() {
    ...
    Assertions.assertEquals(featureCount, inputMatrix.getRows());
    Assertions.assertEquals(100, inputMatrix.getColumns());
    ...
    Assertions.assertEquals(inputMatrix.getRows(), outputMatrix.getRows());

    Assertions.assertEquals(inputMatrix.getColumns(), outputMatrix.getColumns());
    ...
    for (int r = 0; r < outputMatrix.getRows(); r++) {
      for (int c = 0; c < outputMatrix.getColumns(); c++) {
        ...
        Assertions.assertEquals(inputMatrix.get(r, c) * scale + shift, outputMatrix.get(r, c),
            0.000001);
      }
    }
  }
	  ...
	  int featureCount = 10;
	    ...
	    for (int r = 0; r < inputMatrix.getRows(); r++) {
	        for (int c = 0; c < inputMatrix.getColumns(); c++) {
	          ...
	          Assertions.assertEquals(inputMatrix.get(r, c) , finalOutput.get(r, c),
	              0.000001);
	        }
	      }
  }
  ...
  public void testPushRightToLeft() {
    ...
    for (int r = 0; r < inputMatrix.getRows(); r++) {
      for (int c = 0; c < inputMatrix.getColumns(); c++) {
        ...
        double scale = scaleColumnVector.get(r, 0);
        Assertions.assertEquals(inputMatrix.get(r, c) * scale, outputMatrix.get(r, c),
            0.000001);
      }
    }
  }
