...
public abstract class DefaultDirectedComponentChainActivationTestBase extends TestBase {
	...
	public void testConstruction() {
		...
		Assertions.assertNotNull(componentChainActivation);
	}
	...
	public void testGetOutput() {
		...
		DefaultDirectedComponentChainActivation componentChainActivation = createDefaultDirectedComponentChainActivation(
				mockComponentChain, Arrays.asList(mockChainableActivation1, mockChainableActivation2));
		Assertions.assertNotNull(componentChainActivation);
		Assertions.assertNotNull(componentChainActivation.getOutput());
		Assertions.assertSame(mockChainableActivation2.getOutput(), componentChainActivation.getOutput());
	}
	...
	public void testGetActivations() {
		...
		Assertions.assertNotNull(componentChainActivation);
		Assertions.assertNotNull(componentChainActivation.getActivations());
		Assertions.assertFalse(componentChainActivation.getActivations().isEmpty());
		Assertions.assertEquals(2, componentChainActivation.getActivations().size());
		Assertions.assertSame(mockChainableActivation1, componentChainActivation.getActivations().get(0));
		Assertions.assertSame(mockChainableActivation2, componentChainActivation.getActivations().get(1));
	...
	public void testBackPropagate() {
		...
		Assertions.assertSame(mockComponentChain.getInputNeurons().getNeuronCountExcludingBias(),
				backPropagatedGradient.getOutput().getFeatureCount());
		Assertions.assertSame(exampleCount, backPropagatedGradient.getOutput().getExampleCount());
	}
