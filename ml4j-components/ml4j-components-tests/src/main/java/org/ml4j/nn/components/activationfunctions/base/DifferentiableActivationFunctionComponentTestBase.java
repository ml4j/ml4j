...
public abstract class DifferentiableActivationFunctionComponentTestBase<L extends DifferentiableActivationFunctionComponent>
	...
	public void testConstruction() {
		...
		Assertions.assertNotNull(activationFunctionComponent);
	}
	...
	public void testGetComponentType() {
		...
		DifferentiableActivationFunctionComponent activationFunctionComponent = createDifferentiableActivationFunctionComponent(
				neurons, activationFunctionType);
		Assertions.assertNotNull(activationFunctionComponent);
		Assertions.assertEquals(NeuralComponentBaseType.ACTIVATION_FUNCTION,
	...
	public void testForwardPropagate() {
		...
		Assertions.assertFalse(output.getExampleCount() == 0);
		Assertions.assertFalse(output.getFeatureCount() == 0);

		Assertions.assertEquals(neurons.getNeuronCountExcludingBias(), output.getFeatureCount());
		Assertions.assertEquals(mockNeuronsActivation.getExampleCount(), output.getExampleCount());
	...
	public void testDup() {
		...
		Assertions.assertEquals(NeuralComponentBaseType.ACTIVATION_FUNCTION, dupComponent.getComponentType().getBaseType());
	}
